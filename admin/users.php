            ...
            <table class="table table-striped">
              ...
              $result = mysqli_query($conn,"SELECT * FROM `users` ORDER BY ID ASC");
                ...
                while($row = mysqli_fetch_array($result)) {
                    $loop_total = 0;
                    $user = $row['Name'];
                    $result2 = mysqli_query($conn,"SELECT * FROM `hours` WHERE `User`='$user'");
                ...
                <tr id="add_user">
                    <form>
                      ...
                      <td><input type="text" name="Name"></td>
                      <td><input type="tel" name="password" id="inputPassword" style="-webkit-text-security: disc;" maxlength="4" autocomplete="off"></td>
                      <td></td>
                      <td><a class="label label-success">Add</a></td>
                    </form>
                </tr>
              </tbody>
            </table>
